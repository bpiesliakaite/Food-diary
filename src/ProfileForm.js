...
import { accountEdit } from './redux/store';
            ...
            <ScrollView>
                <Form style={{ padding: 30 }}>
                    ...
                    <Item style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                        ...
                        <View >
                            <Button onPress={showDatepicker} style={{ backgroundColor: '#81B29A' }}>
                    ...
                    <Item style={{ alignSelf: 'center', marginTop: 20 }}>
                        <Button onPress={onProfileSave} style={{ borderRadius: 25, backgroundColor: '#81B29A' }}>
